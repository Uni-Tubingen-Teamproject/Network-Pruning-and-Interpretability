...
## PRUNING THE BIAS OF THE CONVOLUTIONAL LAYERS
prune.l1_unstructured(module1, name="bias", amount=6)
# amount=6: 86%

prune.l1_unstructured(module2, name="bias", amount=16)
# amount=16: 87%
# conv1 & conv2: 86%


## PRUNING THE BIAS OF THE FULLY CONNECTED LAYERS
prune.l1_unstructured(fc1, name="bias", amount=120)
# amount=120: 87%

prune.l1_unstructured(fc2, name="bias", amount=84)
# amount=84: 87%

prune.l1_unstructured(fc3, name="bias", amount=10)
# amount=10: 87%
# fc1,fc2,fc3: 87%
